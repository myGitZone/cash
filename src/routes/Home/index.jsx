...
export default class Home extends React.Component {
  ...
  render() {
    const children = [
      ...
      <Content2 id="content_9_1" key="content_9_1" isMode={this.state.isMode}/>,
      <Content3 id="content_2_0" key="content_2_0" isMode={this.state.isMode}/>,
      <Content4 id="content_2_1" key="content_2_1" isMode={this.state.isMode}/>,
